...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Services Section */}
      <section className="py-16 lg:py-28 bg-slate-50 transform-gpu backface-hidden">
        <Container>
          <div className="mb-12">
            <Reveal direction="up">
      ...
      <section className="relative overflow-hidden bg-white py-16 lg:py-28 transform-gpu backface-hidden">
