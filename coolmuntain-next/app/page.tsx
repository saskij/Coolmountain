      ...
      <section className="py-28 bg-slate-50">
        <Container>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] items-stretch gap-10">
              ...
              {/* Right Column - Google Maps Embed (Height Matched) */}
              <Reveal direction="up" delay={0.2}>
                <div className="w-full h-full min-h-[300px] rounded-2xl overflow-hidden shadow-xl border border-slate-100">
                  <iframe
